      ...
      body: Stack(
        ...
        children: [
          ...
          const Positioned(
            top: 420,
            left: 50,
            child: CustomText(text: "Congratulation!", fontSize: 42, fontWeight: FontWeight.bold,)),
            const Positioned(
            top: 480,
            left: 85,
            child: CustomText(text: "Your result is: 10 /10", fontSize: 25, fontWeight: FontWeight.bold,)),
            Positioned(
              top: 430,
              child: SizedBox(
